...
function placeXorO(sqaureNumber) {
    ...
    if (!selectedSquares.some(element=>element.includes(sqaureNumber))) {
        ...
        if (activePlayer==="X") {
            ...
            select.style.backgroundImage="url('images/letter-x.png')";
        ...
        if (activePlayer==="X") {
            //If activePlater is X change it to O
            activePlayer = "O";
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we pass are all included in our array, the true
...
function drawWinLine(coordX1,coordY1,coordX2,coordY2) {
    ...
    //This line indicates where the start of a line's x axis
    let x1 = coordX1,
    ...
    function clear() {
        ...
        c.clearRect(0, 0, 608, 608);
        //This line stops our animation lop
